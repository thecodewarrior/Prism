...
class AssertionsTest {
    ...
    fun assertInstanceOf_withSubclass_shouldSucceed() {
        class SubObject: Object1()
        assertInstanceOf(Object1::class.java, SubObject())
    }
    ...
    fun assertCause_withIncorrectCause_shouldFail() {
        ...
        assertEquals("Hi! ==> Unexpected cause type ==> " +
            "expected: <dev.thecodewarrior.prism.testsupport.AssertionsTest.ExceptionType2> " +
            "but was: <dev.thecodewarrior.prism.testsupport.AssertionsTest.ExceptionType1>",
            e.message
        )
    }
    ...
    fun assertCause_withNoCause_shouldFail() {
        ...
        assertEquals("Hi! ==> Exception has no cause ==> " +
            "expected: <dev.thecodewarrior.prism.testsupport.AssertionsTest.ExceptionType1> " +
            "but was: <null>",
            e.message
        )
    }
